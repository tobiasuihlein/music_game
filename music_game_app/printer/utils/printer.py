...
class SpotifyAPI:
    ...
    def save_tracks_to_json(self, tracks, filename="tracks.json", playlist_name="spotify_playlist"):
        """Save only valid tracks to JSON file"""
        try:
            ...
            print(f"Error saving tracks to JSON: {str(e)}")
